...
const project1 = {
    id: 1,
    time: '2024',
    title: 'the first Java app',
    type: ['mobile'],
    categories: [ 'java', ],
    introduction: ' here should be an introduction of my project',
    imgUrl: 'here is the url of an Image',
    notes: 'here should be the notes in dev mode!',
    projectLink: 'another link to the project'
}

const project2 = {
    id: 2,
    time: '2023',
    title: 'the second react app',
    type: ['web', 'frontend'],
    categories: [ 'react', 'html', 'javascript'],
    introduction: ' here should be an introduction of my project',
    imgUrl: 'here is the url of an Image',
    notes: 'here should be the notes in dev mode!',
    projectLink: 'another link to the project'
...
const project3 = {
    id: 3,
    time: '2022',
    title: 'the third react app',
    type: ['web', 'backend','database'],
    categories: [ 'express', 'nodejs', 'MogonDb'],
    introduction: ' here should be an introduction of my project',
    imgUrl: 'here is the url of an Image',
    notes: 'here should be the notes in dev mode!',
    projectLink: 'another link to the project'
...
createServer({
    ...
    //create seeds 
    seeds(server) {
        server.create("project", project1)
        server.create("project", project2)
        server.create("project", project3)
    },
    //define routes 
    routes() {
        this.namespace = "api"
